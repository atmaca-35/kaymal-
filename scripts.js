document.addEventListener('DOMContentLoaded', async () => {
    ...
    const clickableWords = {
        ...
        "*+gAk": [["<span class='yellow'>intrFEDSRGRDGDSFSDGDSJGDSLKFJDSKLMVDSKMKDMSMFDSÇÖDZFSVDSansitive</span> *dam-", "<span class='gray'>“to drip”</span>", "<span class='yellow'>noun</span> *damgak", "<span class='gray'>“throat”</span>"], ["<span class='yellow'>transitive</span> *or-", "<span class='gray'>“to mow, reap”</span>", "<span class='yellow'>noun</span> *orgak", "<span class='gray'>“sickle”</span>"]],    
